...
The input file is assumed to be a 3-channel sample-synchronized wav file with stationary sources, and has only been tested on examples in the resources/ directory. Other recordings from the given microphone configuration (e.g. non-stationary examples) may produce unexpected results.
